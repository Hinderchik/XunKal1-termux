...
public final class TermuxConstants {
    ...
    /** Termux app name */
    public static final String TERMUX_APP_NAME = "XunKal1 Terminal"; // Default: "Termux"
    /** Termux package name */
    public static final String TERMUX_PACKAGE_NAME = "com.xunkal1.termux"; // Default: "com.termux"
    ...
    public static final class TERMUX_APP {
        ...
        public static final String APPS_DIR_PATH = TERMUX_APPS_DIR_PATH + "/" + TERMUX_PACKAGE_NAME; // Default: "/data/data/com.xunkal1.termux/files/apps/com.termux"

        /** termux-am socket file path */
        public static final String TERMUX_AM_SOCKET_FILE_PATH = APPS_DIR_PATH + "/termux-am/am.sock"; // Default: "/data/data/com.xunkal1.termux/files/apps/com.termux/termux-am/am.sock"
