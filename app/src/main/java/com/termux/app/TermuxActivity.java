...
import com.xunkal1.termux.app.api.file.FileReceiverActivity;
import com.xunkal1.termux.app.terminal.TermuxActivityRootView;
import com.xunkal1.termux.app.terminal.TermuxTerminalSessionActivityClient;
import com.xunkal1.termux.app.terminal.io.TermuxTerminalExtraKeys;
import com.xunkal1.termux.shared.activities.ReportActivity;
import com.xunkal1.termux.shared.activity.ActivityUtils;
import com.xunkal1.termux.shared.activity.media.AppCompatActivityUtils;
...
import com.xunkal1.termux.app.activities.HelpActivity;
import com.xunkal1.termux.app.activities.SettingsActivity;
...
import com.xunkal1.termux.app.terminal.TermuxSessionsListViewController;
import com.xunkal1.termux.app.terminal.io.TerminalToolbarViewPager;
import com.xunkal1.termux.app.terminal.TermuxTerminalViewClient;
import com.xunkal1.termux.shared.termux.extrakeys.ExtraKeysView;
...
import com.xunkal1.termux.shared.termux.theme.TermuxThemeUtils;
import com.xunkal1.termux.shared.theme.NightMode;
...
import com.xunkal1.termux.view.TerminalView;
import com.xunkal1.termux.view.TerminalViewClient;
                ...
                if(PermissionUtils.checkAndRequestLegacyOrManageExternalStoragePermission(
                    ...
                    if (isPermissionCallback)
                        Logger.logInfoAndShowToast(TermuxActivity.this, LOG_TAG,
                            getString(com.xunkal1.termux.shared.R.string.msg_storage_permission_granted_on_request));

                    TermuxInstaller.setupStorageSymlinks(TermuxActivity.this);
                } else {
                    if (isPermissionCallback)
                        Logger.logInfoAndShowToast(TermuxActivity.this, LOG_TAG,
                            getString(com.xunkal1.termux.shared.R.string.msg_storage_permission_not_granted_on_request));
                }
            }
        }.start();
    }
